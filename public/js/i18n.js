...
const I18N = {
  uz: {
    ...
    services_more: 'Barcha xizmatlar',
    gallery_more: "Barcha ishlarni ko'rish",
    cta_title: 'Buyurtma berishga tayyormisiz?',
    cta_text: "Telegram orqali yozing yoki qo'ng'iroq qiling — narx va muddatni birga kelishamiz.",
    cta_telegram: 'Telegramda yozish',
  ...
  ru: {
    ...
    services_more: 'Все услуги',
    gallery_more: 'Смотреть все работы',
    cta_title: 'Готовы сделать заказ?',
    cta_text: 'Напишите в Telegram или позвоните — цену и сроки согласуем вместе.',
